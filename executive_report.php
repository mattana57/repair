            ...
            <div class="flex flex-col lg:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div class="flex flex-wrap items-center justify-start lg:justify-end gap-2.5 w-full lg:w-auto pb-0.5 mt-6 lg:mt-0">
                    ...
                    <form method="GET" action="executive_report.php" class="flex flex-wrap portrait:flex-wrap sm:flex-nowrap items-center gap-2.5 bg-slate-50 dark:bg-slate-800 p-1.5 px-2.5 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-inner w-full lg:w-auto">
                        ...
                        <!-- ✨ บังคับความสูงของปุ่มให้เท่ากับ Dropdown เป๊ะๆ (38px) เฉพาะมือถือแนวตั้ง ✨ -->
                        <button type="submit" class="bg-amber-400 hover:bg-amber-500 text-amber-950 text-xs px-4 portrait:px-5 py-1.5 portrait:py-0 portrait:h-[38px] flex items-center justify-center rounded-full font-extrabold transition-all shadow-sm shrink-0">
                            ค้นหา
                        </button>
                    </form>
