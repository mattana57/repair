...
<body class="flex h-screen overflow-hidden selection:bg-indigo-100">
    ...
    <main class="flex-1 flex flex-col min-w-0 overflow-hidden relative bg-[#f8fafc]">
        ...
        <div class="flex-1 overflow-y-auto p-6 lg:p-8">
            ...
            <div id="dash" class="section space-y-6 animate-fade-in no-print">
                ...
                <!-- ✨ จุดที่ 1: แบ่งครึ่งหน้าจอ (grid-cols-2) ปรับความสูงเป็น h-[280px] ให้เท่ากันหมด ดูกว้างโปร่งตา ไม่อึดอัด ✨ -->
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div class="modern-card p-6 flex flex-col">
                        <div class="flex justify-between items-start mb-4">
                            <div>
                ...
                <!-- ✨ ส่วน Rating & Review (เปลี่ยนเป็นแท่งแนวนอนแบบ Progress Bar 5 ดาว ไป 1 ดาว) ความสูงสมมาตรกับด้านบน (h-[280px]) ✨ -->
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
                    ...
                    <div class="modern-card p-6 flex flex-col lg:col-span-2 justify-between">
                        ...
                        <div class="flex flex-col md:flex-row items-center gap-8 w-full mt-2 flex-1">
                            ...
                            <!-- Chart Area (แก้บั๊กเพิ่ม w-full min-w-0 แล้วเปลี่ยน Javascript เป็นแท่งแนวนอน) -->
                    ...
                    <div class="modern-card overflow-hidden flex flex-col lg:col-span-1 h-full">
                        ...
                        <!-- ✨ ล็อคความสูงและใส่คำสั่งเลื่อน Scrollbar ให้พอดีกับกล่องฝั่งซ้าย (280px พอดีเป๊ะ) ✨ -->
    ...
    <script>
        ...
        function renderRatingChart() {
            ...
            // ใช้กราฟแท่งแนวนอน (Horizontal Bar Chart) เหมือน Progress Bar
            let dataCounts = [counts[4], counts[3], counts[2], counts[1], counts[0]]; // เรียงจาก 5 ดาวไป 1 ดาว
