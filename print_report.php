...
<body class="bg-slate-50 text-slate-800 dark:bg-slate-800 dark:text-slate-100">
    ...
    <!-- แถบเมนูควบคุม (ปรับแก้จัดวาง Layout ตามที่คุณต้องการ) -->
    <div class="no-print bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 py-4 px-6 sticky top-0 z-50 shadow-md transition-colors duration-300">
        <div class="max-w-7xl mx-auto flex flex-col gap-4">
            ...
            <!-- บรรทัดที่ 1: ซ้าย (Dashboard+หัวข้อ) | ขวา (กรองข้อมูล+โหมดมืด) -->
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div class="flex flex-wrap items-center justify-start md:justify-end gap-2.5 w-full md:w-auto">
                    ...
                    <button id="theme-toggle" type="button" class="w-9 h-9 rounded-full bg-white dark:bg-slate-600 border-2 border-slate-200 dark:border-slate-500 text-slate-500 dark:text-amber-400 shadow-sm hover:text-indigo-600 dark:hover:text-amber-300 transition-all flex items-center justify-center shrink-0 ml-1">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center gap-4 mt-2 md:mt-0">
                ...
                <div class="flex items-center w-full md:w-auto justify-start md:justify-end pr-2">
                    <label for="toggleSignature" class="flex items-center cursor-pointer">
                        ...
                        <div class="relative flex items-center">
                            ...
                            <div class="w-9 h-5 bg-slate-300 dark:bg-slate-600 peer-focus:outline-none rounded-full peer peer-checked:bg-indigo-500 transition-colors duration-300"></div>
