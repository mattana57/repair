...
<body class="bg-slate-100 text-slate-800 dark:bg-slate-950 dark:text-slate-100 min-h-screen flex flex-col">
    ...
    <div class="no-print bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 py-4 px-6 sticky top-0 z-50 shadow-md transition-colors duration-300">
        ...
        <!-- ✨ แก้ไข Layout แถบเมนู ให้รองรับ iPad แนวตั้งเป๊ะๆ (จัดลำดับ Order ใหม่ให้ไขว้กันพอดี) ✨ -->
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row md:flex-wrap items-center gap-y-4">
            
            <!-- [1] Dashboard & Title -->
            <div class="w-full md:w-auto flex justify-center md:justify-start shrink-0 order-1">
            ...
            <!-- [2] ลายเซ็นท้ายเอกสาร (Tablet: ขวาบน | Desktop: ขวาล่าง) -->
            <div class="w-full md:w-auto flex justify-center md:justify-end order-2 lg:order-6 md:ml-auto lg:ml-auto pr-1">
            ...
            <!-- [3] Form ค้นหา (Tablet: ขวาล่าง | Desktop: ขวาบน) -->
            <div class="w-full lg:w-auto flex justify-center lg:justify-end order-6 lg:order-2 lg:ml-auto pb-0.5">
                <form method="GET" action="print_report.php" class="flex flex-wrap items-center justify-center gap-2.5 bg-slate-50 dark:bg-slate-800 p-1.5 px-2.5 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-inner w-full sm:w-auto">
            ...
            <!-- [4] โหมดพระจันทร์ (Tablet: ขวาบน (ติด Sig) | Desktop: ขวาบน (ติด Form)) -->
            <div class="shrink-0 flex justify-center order-3 lg:order-3 md:ml-4 lg:ml-2.5">
                <button id="theme-toggle" type="button" class="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-500 dark:text-amber-400 shadow-sm flex items-center justify-center hover:bg-slate-50 dark:hover:bg-slate-600 transition-colors">
                    <i id="theme-toggle-icon" class="fas fa-moon"></i>
                </button>
            </div>

            <!-- 🛑 ตัวแบ่งบรรทัด (บังคับให้ขึ้นบรรทัดใหม่เฉพาะใน iPad แนวตั้ง) -->
            <div class="w-full hidden md:block lg:hidden order-4 h-0 m-0 p-0 border-0"></div>

            <!-- [5] Links ตาราง/บันทึก (Tablet: ซ้ายล่าง | Desktop: ซ้ายล่าง) -->
            <div class="w-full md:w-auto flex justify-center md:justify-start gap-2.5 order-5 lg:order-5 md:mr-auto mt-2 md:mt-0">
