...
<body class="bg-slate-100 text-slate-800 dark:bg-slate-950 dark:text-slate-100 min-h-screen flex flex-col">
    ...
    <!-- ✨ แถบเมนูด้านบน (Top Bar) จัดเรียงใหม่แบบ Balance ✨ -->
    <div class="no-print bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 py-4 px-6 sticky top-0 z-50 shadow-sm transition-colors duration-300">
        <div class="max-w-[1400px] mx-auto flex flex-col gap-4">
            ...
            <div class="flex flex-col xl:flex-row justify-between items-center gap-4">
                ...
                <div class="flex flex-wrap items-center justify-center xl:justify-end gap-2.5 w-full xl:w-auto">
                    <form method="GET" action="print_report.php" class="flex flex-wrap items-center gap-2.5">
                        ...
                        <!-- ช่องค้นหาช่าง (Dropdown อัจฉริยะ) -->
                        <div class="relative w-48 sm:w-60" id="techDropdownContainer">
                        ...
                        <!-- เลือกเดือน -->
                        <select name="month" class="custom-select bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-100 font-bold text-xs rounded-full px-3 py-2 border border-slate-200 dark:border-slate-600 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 cursor-pointer transition-colors w-28 sm:w-auto">
                            <?php 
                            for($m=1; $m<=12; $m++) {
                        ...
                        <!-- เลือกปี -->
                        <select name="year" class="custom-select bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-100 font-bold text-xs rounded-full px-3 py-2 border border-slate-200 dark:border-slate-600 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 cursor-pointer transition-colors w-24 sm:w-auto">
                            <?php 
                    ...
                    <!-- ปุ่มสลับโหมดมืด -->
                    <button id="theme-toggle" type="button" class="w-9 h-9 rounded-full bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-500 dark:text-amber-400 hover:text-indigo-600 dark:hover:text-amber-300 transition-all flex items-center justify-center shrink-0 ml-1">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                <!-- ซ้าย: เลือกรูปแบบ และ พิมพ์ -->
                <div class="flex flex-wrap items-center justify-center sm:justify-start gap-3 w-full sm:w-auto">
                    <!-- ปุ่มสลับ ตาราง/ข้อความ -->
                    <div class="flex items-center gap-1 bg-slate-50 dark:bg-slate-800/50 p-1 rounded-full border border-slate-200 dark:border-slate-700">
                        <a href="print_report.php?type=table&tech=<?php echo urlencode($selected_tech); ?>&month=<?php echo $selected_month; ?>&year=<?php echo $selected_year; ?>" 
                           class="px-4 py-1.5 rounded-full text-xs font-bold transition-all flex items-center <?= $report_type === 'table' ? 'bg-white text-indigo-700 shadow-sm dark:bg-slate-700 dark:text-white' : 'text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200' ?>">
                        ...
                        <a href="print_report.php?type=memo&tech=<?php echo urlencode($selected_tech); ?>&month=<?php echo $selected_month; ?>&year=<?php echo $selected_year; ?>" 
                           class="px-4 py-1.5 rounded-full text-xs font-bold transition-all flex items-center <?= $report_type === 'memo' ? 'bg-white text-indigo-700 shadow-sm dark:bg-slate-700 dark:text-white' : 'text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200' ?>">
                    ...
                    <button type="button" onclick="window.print()" class="bg-slate-900 hover:bg-black dark:bg-rose-800 dark:hover:bg-rose-700 text-white text-xs px-5 py-2 rounded-full font-bold shadow-md transition-all flex items-center">
                ...
                <div class="flex items-center justify-center sm:justify-end w-full sm:w-auto pr-1">
                    <label class="flex items-center cursor-pointer group">
                        <span class="mr-3 text-[11px] font-bold text-slate-500 dark:text-slate-400 group-hover:text-slate-700 dark:group-hover:text-slate-200 transition-colors">ลายเซ็นท้ายเอกสาร</span>
                        <div class="relative flex items-center">
                            ...
                            <div class="absolute left-[2px] top-[2px] bg-white rounded-full h-4 w-4 transition-transform duration-300 peer-checked:translate-x-[16px] shadow-sm"></div>
                        </div>
                    </label>
                </div>
        ...
        <?php if ($report_type === 'memo'): ?>
            ...
            <div class="a4-container">
                <div class="flex-1 flex flex-col">
                    ...
                    <!-- ✨ บล็อกลายเซ็นที่ถูกควบคุมให้ซ่อน/แสดงได้ ✨ -->
