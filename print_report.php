...
<body class="bg-slate-100 text-slate-800 dark:bg-slate-950 dark:text-slate-100 min-h-screen flex flex-col">
    ...
    <!-- ✨ แถบเมนูด้านบน (Top Bar) จัดเรียงใหม่ตามรูปภาพ (Balance 2 บรรทัด) ✨ -->
    <div class="no-print bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 py-3 px-6 sticky top-0 z-50 shadow-sm transition-colors duration-300">
        <div class="max-w-[1400px] mx-auto flex flex-col gap-3">
            
            <!-- บรรทัดที่ 1: Dashboard + หัวข้อ (ซ้าย) | กรองข้อมูล + โหมดมืด (ขวา) -->
            <div class="flex flex-col xl:flex-row justify-between items-center gap-3">
                
                <div class="flex items-center space-x-4 w-full xl:w-auto justify-center xl:justify-start shrink-0">
                    <a href="dashboard.php?tab=reports" class="bg-violet-50 hover:bg-violet-100 text-violet-700 border border-violet-200 dark:bg-violet-600/20 dark:hover:bg-violet-500/30 dark:border-violet-600/50 dark:text-violet-300 px-4 py-2 rounded-full text-xs font-bold transition-all flex items-center shadow-sm">
                ...
                <div class="flex flex-wrap items-center justify-center xl:justify-end gap-2.5 w-full xl:w-auto">
                    <form method="GET" action="print_report.php" class="flex flex-wrap items-center gap-2">
                        <input type="hidden" name="type" value="<?php echo htmlspecialchars($report_type); ?>">
                        
                        <div class="relative w-48 sm:w-56" id="techDropdownContainer">
                            ...
                            <div id="techDropdownList" class="absolute z-50 w-full sm:w-72 mt-1 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl shadow-xl max-h-80 overflow-y-auto hidden flex-col py-2 custom-scrollbar right-0 sm:right-auto sm:left-0">
                                <div class="tech-dropdown-item px-3 py-1.5 mx-2 rounded-lg text-xs font-bold text-slate-600 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700 cursor-pointer transition-colors flex items-center" data-value="all" data-search="รวมทุกฝ่ายงานทั้งหมด" onmousedown="selectTech('all', 'รวมทุกฝ่ายงาน (ทั้งหมด)')">
                        ...
                        <select name="month" class="custom-select bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-100 font-bold text-xs rounded-full px-3 py-1.5 border border-slate-200 dark:border-slate-600 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 cursor-pointer transition-colors w-24 sm:w-auto">
                            <?php 
                            for($m=1; $m<=12; $m++) {
                        ...
                        <select name="year" class="custom-select bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-100 font-bold text-xs rounded-full px-3 py-1.5 border border-slate-200 dark:border-slate-600 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 cursor-pointer transition-colors w-24 sm:w-auto">
                            <?php 
                    ...
                    <button id="theme-toggle" type="button" class="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-500 dark:text-amber-400 hover:text-indigo-600 dark:hover:text-amber-300 transition-all flex items-center justify-center shrink-0">
                        <i id="theme-toggle-icon" class="fas fa-moon"></i>
                    </button>
                </div>
            </div>

            <!-- บรรทัดที่ 2: รูปแบบเอกสาร + พิมพ์ (ซ้าย) | สวิตช์ลายเซ็น (ขวา) -->
            <div class="flex flex-col sm:flex-row justify-between items-center gap-3">
                ...
                <div class="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                    ...
                    <div class="hidden sm:block w-px h-5 bg-slate-200 dark:bg-slate-700 mx-1"></div>
                    
                    <button type="button" onclick="window.print()" class="bg-slate-900 hover:bg-black dark:bg-rose-800 dark:hover:bg-rose-700 text-white text-xs px-5 py-1.5 rounded-full font-bold shadow-md transition-all flex items-center">
                ...
                <div class="flex items-center justify-center sm:justify-end w-full sm:w-auto">
                    <label class="flex items-center cursor-pointer bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-4 py-1.5 rounded-full hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors shadow-sm">
